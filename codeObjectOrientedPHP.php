...
class Fish
{
    ...
    public function getInfo(){
      return $this->common_name . 'is' . $this->flavor . 'The world record weight is ' . $this->record_weight;
    }
}
...
$recipe1->addInstruction("This is my first instruciton");
$recipe1->addInstruction("This is my second instruciton");
